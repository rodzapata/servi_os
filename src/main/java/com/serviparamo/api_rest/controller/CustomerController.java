...
import com.serviparamo.api_rest.service.CustomerService;
...
public class CustomerController {
    ...
    @PostMapping()
    public ServerResponseDataDto create(@RequestBody @Valid CustomerDto dto) {

        CustomerDto response = this.service.create(dto);
    ...
    public ServerResponseDataDto findAll() {
        ...
        List<CustomerDto> dtos = this.service.findAll();
    ...
    public ServerResponseDataDto findById(@PathVariable("id") Long id) {
        ...
        CustomerDto dto = this.service.getById(id);
    ...
    public ServerResponseDataDto updateById(
            ...
            @RequestBody @Valid CustomerDto newData
    ) {

        CustomerDto dto = this.service.updateById(id, newData);
